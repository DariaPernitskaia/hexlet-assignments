...
class AppTest {
    ...
    void testTake() {
        ...
        List<Integer> result1 = App.take(input1, n1);
        ...
        List<Integer> result2 = App.take(input2, n2);
        ...
        List<Integer> result3 = App.take(input3, n3);
        ...
        List<Integer> result4 = App.take(input4, n4);
